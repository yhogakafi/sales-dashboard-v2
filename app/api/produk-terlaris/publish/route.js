...
import { saveProdukPeriod } from '@/lib/blob'

export const runtime = 'nodejs'

// Tahap 2: simpan hasil parse sebagai periode produk terlaris (baru atau timpa
// yang sudah ada). Periode ini terpisah dari periode data penjualan.
export async function POST(request) {
  ...
  try {
    const entry = await saveProdukPeriod({
      id: periodId,
      label: periodLabel,
      analysis,
